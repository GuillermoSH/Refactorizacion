...
public class EjercicioArrays {
    private int maxNota;
    private int minNota;
    private int indMaxNota;
    private int indMinNota;
    ...
    public int obtenerIndMaxNota(List<Integer> notas) {
        return notas.indexOf(buscarMayorNota(notas)) + 1;
    }

    public int obtenerIndMinNota(List<Integer> notas) {
        return notas.indexOf(buscarMenorNota(notas)) + 1;
    }
    ...
    private int buscarMayorNota(List<Integer> notas) {
        Collections.sort(notas, Collections.reverseOrder());
        return notas.get(0);
    }

    private int buscarMenorNota(List<Integer> notas) {
